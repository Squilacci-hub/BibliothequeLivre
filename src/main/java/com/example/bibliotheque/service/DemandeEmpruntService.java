...
public class DemandeEmpruntService {
    ...
    public void traiterDemande(Integer demandeId, DemandeEmprunt.StatutDemande nouveauStatut, String commentaire) {
        ...
        if (nouveauStatut == DemandeEmprunt.StatutDemande.ACCEPTEE &&
            ...
            Emprunt emprunt = Emprunt.builder()
                ...
                .dateEmprunt(demande.getDateDemande()) // Utiliser la date de demande au lieu de LocalDate.now()
                .dateRetourPrevue(demande.getDateDemande().plusDays(7)) // 7 jours après la date de demande
                .prolonge(false)
                .rendu(false)
                .build();
    ...
    public void sauvegarderDemande(DemandeEmprunt demande) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'sauvegarderDemande'");
    }
}
