...
public class AdherentController {
    ...
    public String creerDemande(@RequestParam Integer livreId,
                            ...
                            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dateAction,
                            HttpSession session,
        ...
        try {
            ...
            demandeService.creerDemande(adherent, livre, action, dateAction);
    ...
    @GetMapping("/adherent/abonnement")
    public String voirAbonnement(HttpSession session, Model model) {
        Adherent adherent = (Adherent) session.getAttribute("adherent");
        if (adherent == null) return "redirect:/login-adherent";
        
        model.addAttribute("abonnement", 
            abonnementService.getAbonnementByAdherentId(adherent.getId()));
