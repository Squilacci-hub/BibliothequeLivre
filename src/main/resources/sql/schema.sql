...
ALTER TABLE demande_emprunt ADD COLUMN date_demandee DATE AFTER date_demande;
ALTER TABLE emprunt ADD COLUMN date_demande DATE;   
ALTER TABLE emprunt ADD COLUMN id_demande_emprunt INT;
ALTER TABLE emprunt ADD FOREIGN KEY (id_demande_emprunt) REFERENCES demande_emprunt(id);
...
-- Ajoutez un index pour améliorer les performances
CREATE INDEX idx_abonnement_adherent ON abonnement(id_adherent);


ALTER TABLE adherent ADD COLUMN id_abonnement INT;
ALTER TABLE adherent ADD FOREIGN KEY (id_abonnement) REFERENCES abonnement(id);